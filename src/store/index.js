...
const store = createStore({
  modules: { room: room, students: students },
  state() {
    return {
      count: 0,
      layout: "main",
      listSideMenus: [
        ...
        { text: "Professor", to: "/professors", icon: "adjust", active: false, mouseHover: false },
      ...
      listLevel: [
        { id: "smhsq8g", name: "Préparatoire", short: "Prépa", color: "#8B70D3", current: true },
