                        ...
                        <div class="rounded-lgbg-white max-w-sm">
                            <div class="p-2 flex flex-col items-center">
                                ...
                                <div class="rounded-full bg-green-50 h-16 w-16 cursor-pointer overflow-clip">
                                    <img :src="chance.avatar({ protocol: 'https', fileExtension: 'jpg' })" />
                                </div>
...
import { UserAddIcon, DotsHorizontalIcon, MailIcon, PhoneIcon, ArrowCircleDownIcon, PencilIcon } from "@heroicons/vue/solid"
